const CACHE='iris-v4.3.0-black-light-icon23';
const CORE=[
  '/health-/?v=43&music=4',
  '/health-/index.html?v=43&music=4',
  '/health-/styles.css?v=iris43',
  '/health-/journal.css?v=iris43',
  '/health-/iris-data.js?v=iris43',
  '/health-/iris-journal.js?v=iris43',
  '/health-/iris-extras.js?v=iris43',
  '/health-/iris-motion.js?v=iris43',
  '/health-/iris-engine.js?v=iris43',
  '/health-/iris-music.m4a?v=4',
  '/health-/iris-v11.js?v=iris43',
  '/health-/iris-v24.js?v=iris43',
  '/health-/manifest.webmanifest?v=iris43-icon23',
...
self.addEventListener('fetch',event=>{
  ...
  event.respondWith((async()=>{
    ...
    if(navigation)return await cache.match('/health-/?v=43&music=4')||Response.error();
